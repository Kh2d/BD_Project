...
public class DoctorSystemGUImain extends JFrame
{
    ...
    private JPanel p1 , p2 , DoctorSys , newDonationHeader ,newDonationDoctor ,  DonationReportHeader , DonationReport;
    ...
    private JLabel l1, DoctorTitle , DoctorImage , NewDonationTitle , NewDonationImage, DonationReportTitle , DonationReportImage;
