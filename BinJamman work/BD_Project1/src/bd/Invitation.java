...
//        p2.setLayout(null);
        ...
        invitationLabel = new JLabel("Invitations");
        invitationLabel.setFont(new Font("Georgia", Font.PLAIN, 22));
        invitationLabel.setForeground(new Color(50, 50, 25));
        invitationLabel.setBounds(250, 20, 50, 50);
        p2.add(invitationLabel);
        add(p2);
        
        cancel = new JButton("Cancel");
        cancel.setBounds(320, 350, 80, 20);
        add(cancel);
